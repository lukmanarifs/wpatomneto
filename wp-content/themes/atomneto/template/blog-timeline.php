							...
							<div class="row">
								<div class="col-md-10 col-md-offset-1">
									...
									<div class="timeline row">
										...
										<div class="timeline-date-label clearfix">September 2014</div>
										...
										<!-- timeline item start -->
										<div class="timeline-item <?php echo (++$j % 2 == 0) ? 'pull-right' : ''; ?> object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="200">
											<!-- blogpost start -->
