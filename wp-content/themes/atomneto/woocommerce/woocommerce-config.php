...
if (class_exists( 'woocommerce' )) {
	...
	if( intval(atom_get_options_key('woocommerce-page-num')) > 0){
...
function atom_get_wishlist($add_wishlist = '', $just_added = '', $view_wishlist = ''){
	...
	$html .= '><a href="' . esc_url( $yith_wcwl->get_addtowishlist_url() ) . '" data-product-id="' . $product->id . '" data-product-type="' . $product_type . '" ' . $classes . ' ><i class="fa fa-star-o"></i>'.$add_wishlist.'<div class="ajax-loading" id="add-items-ajax-loading" style="visibility:hidden"><i class="fa fa-spinner fa-spin"></i></div></a>';
