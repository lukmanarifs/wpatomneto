<?php
/**
 * The template for displaying mini bar
 */
...
?>
<a href="<?php echo $yith_wcwl->get_wishlist_url(); ?>"><i class="fa fa-star"></i></a>
<?php if( count( $wishlist ) > 0 ) { ?>
<div class="minibar-content">
	<p class="total"><strong><?php _e( 'Total', 'atom' ); ?>:</strong> <?php echo count( $wishlist ); ?></p>
    <ul class="mline">
    <?php
	...
	<a href="<?php echo $yith_wcwl->get_wishlist_url(); ?>" class="btn btn-theme checkout"><?php _e( 'Go to your Wishlist', 'atom' ); ?></a>
<?php }else { ?>
<div class="minibar-content empty">
    <p><?php _e( 'No products were added to the wishlist', 'atom' ); ?></p>
    <p><a href="<?php echo $yith_wcwl->get_wishlist_url(); ?>" class="btn btn-theme"><?php _e( 'Go to your Wishlist', 'atom' ); ?></a></p>
<?php } ?>
