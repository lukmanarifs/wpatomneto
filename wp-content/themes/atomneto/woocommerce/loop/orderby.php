...
<form class="woocommerce-ordering" method="get">
	<ul class="orderby-list mline">
		...
		<?php
			$catalog_orderby = apply_filters( 'woocommerce_catalog_orderby', array(
				'menu_order' => __( 'Default sorting', 'atom' ),
				'popularity' => __( 'Sort by popularity', 'atom' ),
				'rating'     => __( 'Sort by average rating', 'atom' ),
				'date'       => __( 'Sort by newness', 'atom' ),
				'price'      => __( 'Sort by price: low to high', 'atom' ),
				'price-desc' => __( 'Sort by price: high to low', 'atom' )
			) );
    ...
    <div class="woocommerce-ordering-listorder">
        <a class="listorder-price <?php 
         ...
         ;?>"><span><i class="fa fa-arrow-up"></i><i class="fa fa-arrow-down"></i></span><?php _e( 'Price', 'atom' );?></a>
        <a class="listorder-popularity <?php 
            if($orderby == "popularity"){ 
                echo "select";
            }
         ;?>"><?php _e( 'Popularity', 'atom' );?></a>
        <a class="listorder-rate <?php 
            if($orderby == "rating"){ 
                echo "select";
            }
         ;?>"><?php _e( 'Rating', 'atom' );?></a>
    </div>
    <div class="orderby-list-page-number">
		 <?php 
			$default_page_num = intval( atom_get_options_key('woocommerce-page-num') );
			...
			$page_arr = array(__('Show ','atom').$default_page_num.__(' Products', 'atom'), __('Show ','atom').intval($default_page_num * 2).__(' Products', 'atom'), __('Show ','atom').intval($default_page_num * 3).__(' Products', 'atom'));
