...
require_once("atomcore-functions.php");
require_once("atomcore-plugin-function.php");
require_once("atomcore-theme-options.php");
require_once("atomcore-meta-boxes.php");
require_once("atomcore-sidebars.php");
require_once("modules/atomcore-megamenu.php");
require_once("modules/atomcore-post.php");
				...
				<tbody>
					<tr valign="top">	
						...
						<td>
							...
							<label class="description" for="atom_license_email"><?php _e('Enter your Registered Email. We already sent from <strong>ipn@atomcave.com</strong>'); ?></label>
						</td>
					</tr>
					...
					<tr valign="top">	
						...
						<td>
							...
							<label class="description" for="atom_license_secretkey"><?php _e('Click blue button below to get activation code in your registered email.'); ?>
					...
					<?php submit_button(); ?>
							...
							<input name="themes" type="hidden" value="atomstore" />
    ...
    $calcedVerify = strtoupper(substr($calcedVerify,0,30));
		...
		global $pagenow;
		 if ( is_admin() && isset( $_GET['settings-updated'] ) && $pagenow == 'admin.php' )
		 {
			...
			global $pagenow;
			 if ( ( is_admin() && $_GET['page'] == 'ot-theme-options' && $pagenow == 'admin.php' ) || ( is_admin() && $_GET['page'] == 'atomcore-import-export' && $pagenow == 'admin.php' ) )
			 {
