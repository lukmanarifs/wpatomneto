...
function siteorigin_metaslider_layout_big_headline($layouts){
	$layouts['big-headline'] = array(
		'title' => __('Big Headline', 'atom'),
		'html' =>
			siteorigin_metaslider_layer(
				'<h2><span style="font-size: 2.75em; color: #FFFFFF; text-align: center">'.__('This Is The First Line', 'atom').'<br/><span style="font-weight:300">'.__('This is The Second', 'atom').'</span></span></h2>',
			...
			siteorigin_metaslider_layer(
				'<p class="siteorigin-slider-action-button"><a href="#"><span>'.__('An Action Button', 'atom').'</span></a></p>',
				array('text-align' => 'center'),
