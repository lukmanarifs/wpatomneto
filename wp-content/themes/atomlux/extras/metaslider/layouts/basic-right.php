...
function siteorigin_metaslider_layout_basic_right($layouts){
	$layouts['basic-right'] = array(
		'title' => __('Basic Right', 'atom'),
		'html' =>
			siteorigin_metaslider_layer(
				'<h2><span style="font-size: 2.75em; color: #FFFFFF">'.__('This Is The First Line', 'atom').'<br/><span style="font-weight:300">'.__('This is The Second', 'atom').'</span></span></h2>',
				array(),
