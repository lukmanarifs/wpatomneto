 ...
 * @return string
 */
function atom_gallery($contents, $attr){
	...
	foreach($attachments as $attachment){
		$return .= '<li>';
		$return .= apply_filters('atom_slide_before', '', $attachment);
		...
		$return .= apply_filters('atom_slide_after', '', $attachment);
		$return .= '</li>';
	}
	$return .= '</ul>';
	$return .= '</div>';
 ...
 * @since atom 1.0
 */
function atom_gallery_types($types){
	$types['slider'] = __('Slider', 'atom');
	return $types;
}
add_filter('siteorigin_gallery_types', 'atom_gallery_types');
 ...
 * @since atom 1.0
 */
function atom_gallery_default_type(){
	return 'slider';
}
add_filter('siteorigin_gallery_default_type', 'atom_gallery_default_type');